"""Sensor platform for starlingdevconnect."""
...
class StarlingDevConnectSensor(StarlingDevConnectEntity, SensorEntity):
    """starlingdevconnect Sensor class."""
